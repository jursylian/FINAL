...
export default function PostCreateModal({ onClose }) {
  const { user } = useAuth();
      ...
      <div className="relative z-[71] w-full md:w-[900px] max-w-[92vw] overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        >
          ...
          <div className="flex w-full md:w-[320px] flex-col">
            ...
            <div className="flex-1 border-b border-[#DBDBDB] px-4 py-3">
              <textarea
                value={caption}
            ...
            <div className="border-t border-[#DBDBDB] px-4 py-3 text-[12px] text-[#8E8E8E]">
